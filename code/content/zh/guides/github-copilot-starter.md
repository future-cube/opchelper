...
*** Add File: /Users/xing/Documents/Dev/Project/opchelper/.worktrees/ai-tools-extra/code/content/en/guides/github-copilot-starter.md
---
title: "GitHub Copilot / VS Code Copilot Chat: starter workflow"
description: "Solo-operator view: set boundaries and make outputs verifiable (diffs + build/test)."
tags: ["copilot", "github", "vscode", "coding"]
updatedAt: "2026-03-10"
---
...
- ask for small diffs
- require verification commands (build/test) with expected results
